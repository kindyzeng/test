...
public class QueryPartition50 extends BaseBasicBolt {
	...
	public void execute(Tuple input, BasicOutputCollector collector) {
		...
		if(range!="")
		{
			...
			int rowMax = (int)(Ymax/468);
			int rowMin = (int)(Ymin/468);
			int colMax = (int)(Xmax/476);
			int colMin = (int)(Xmin/476);
...
//			String id=uuid.toString()+","+(rowMax-rowMin+1)*(colMax-colMin+1);
			...
			for(int i=rowMin;i<=rowMax;i++)
			{
				...
				{	    		
					Envelope envelopeIndex  = new Envelope(j*476,i*468, (j+1)*476, (i+1)*468);
