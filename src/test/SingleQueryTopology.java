 ...
 */
public class  SingleQueryTopology {
...
//		
		...
		builder.setSpout("QuerySpout", new  SingleDataSetQuerySpout (args[2]), 7);	
		builder.setBolt("RStreeIndex", new  SingleRtreeQueryBolt(args[3]),4).setMaxTaskParallelism(50).allGrouping("QuerySpout");
