...
public class QueryPartition25 extends BaseBasicBolt {
	...
	public void execute(Tuple input, BasicOutputCollector collector) {
		...
		if(range!="")
		{
			...
			int rowMax = (int)(Ymax/936);
			int rowMin = (int)(Ymin/936);
			int colMax = (int)(Xmax/952);
			int colMin = (int)(Xmin/952);
...
//			String id=uuid.toString()+","+(rowMax-rowMin+1)*(colMax-colMin+1);
			...
			for(int i=rowMin;i<=rowMax;i++)
			{
				...
				{	    		
					Envelope envelopeIndex  = new Envelope(j*952,i*936, (j+1)*952, (i+1)*936);
