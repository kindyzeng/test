...
//23800*23400
public  class UpdatePartition200 extends BaseBasicBolt {
	...
	private List<String> ComputeAffecGrid(double x,double y)
	{
		...
		int maxrow = GetMin((int)(y+joinDistance)/117,200);
		int maxcol =GetMin((int)(x+joinDistance)/119,200);
		int minrow = GetMax(0,(int)(y-joinDistance)/117);
		int mincol =GetMax(0,(int)(x-joinDistance)/119);
...
//		}
	...
	public UpdatePartition200(double joinDistance) {
		super();
