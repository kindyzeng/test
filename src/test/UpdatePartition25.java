...
//23800*23400
public  class UpdatePartition25 extends BaseBasicBolt {
	...
	private List<String> ComputeAffecGrid(double x,double y)
	{
		...
		int maxrow = GetMin((int)(y+joinDistance)/936,25);
		int maxcol =GetMin((int)(x+joinDistance)/952,25);
		int minrow = GetMax(0,(int)(y-joinDistance)/936);
		int mincol =GetMax(0,(int)(x-joinDistance)/952);
	...
	public UpdatePartition25(double joinDistance) {
		super();
